#This version does not use the RSF covariate
...
rsf.beta1 <- 0 #rsf coefficient, assumed to be 0 for model fitting in this testscript
...
rsf.beta2 <- 0 #rsf coefficient, assumed to be 0 for model fitting in this testscript
...
Nimdata <- list(y1=nimbuild$y2D1,y2=nimbuild$y2D2,
                dSS=data$constants$dSS,InSS=data$constants$InSS,rsf.beta1=0,rsf.beta2=0)  #fix these to 0 to turn of D.covs D.beta11=0,D.beta12=0
